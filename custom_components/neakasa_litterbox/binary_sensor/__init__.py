"""Binary sensor platform for Neakasa Litterbox."""
...
from .bucket_full import NeakasaBucketFullBinarySensor
from .needs_cleaning import NeakasaNeedsCleaningBinarySensor
...
def _device_entities(
    ...
    """Return the per-device binary sensors."""
    return [
        NeakasaNeedsCleaningBinarySensor(coordinator, iot_id),
        NeakasaBucketFullBinarySensor(coordinator, iot_id),
    ]
...
async def async_setup_entry(
    ...
    """Set up binary sensor entities, dynamically tracking new devices."""
