"""Button platform for Neakasa Litterbox."""
...
from .clean_now import NeakasaCleanNowButton
from .level_now import NeakasaLevelNowButton
...
__all__ = ["NeakasaCleanNowButton", "NeakasaLevelNowButton"]
...
def _device_entities(
    ...
    """Return the per-device button entities."""
    return [
        NeakasaCleanNowButton(coordinator, iot_id),
        NeakasaLevelNowButton(coordinator, iot_id),
    ]
...
async def async_setup_entry(
    ...
    """Set up button entities, dynamically tracking new devices."""
